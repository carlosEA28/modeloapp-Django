...
urlpatterns = [
    ...
    path('clientsocialnetworks/', include('clientsocialnetworks.urls', namespace="clientsocialnetworks")),
    path('orderitems/', include('orderitems.urls', namespace="orderitems")),
]
